...
colnames(cs.samyuan) <- c("X","cs")

for (ii in unique(cs.samyuan$cs) ) {
  
  
  cs.samyuan.A.domin <- cs.samyuan   %>%   filter(cs == ii)
  cs.samyuan.f <- cs.samyuan.A.domin
  
  f1.samyuan <-  f1.3
  
  express <- dplyr::left_join(cs.samyuan.A.domin,f1.samyuan)
  
  express.1<- express[,c(1,3,4,5,7)]  #%>% column_to_rownames("X")
  raw.expr <- express.1
  ...
  cluster0<-cbind(C0[,2],C0[,3],C0[,4],C0[,5])
  ...
  # clu0 <- clu0[rowSums(clu0) > 0.5,]
  head(clu0)
  #write.csv(clu0,"cr.cs.sanyuan.expr.out.csv")
  ...
  #write.csv(tridat01,"cr.cs.tridat_cluster.csv")
  ...
  pdf(paste0("dif_out/VEtoEL.",ii,".to.sanyuan.pdf"),width = 10, height = 10)
  # pdf("A.do.to.sanyuan.pdf",width = 10, height = 10)
  print(p)
  dev.off()
  png(paste0("dif_out/VEtoEL.",ii,".to.sanyuan.png"),width =8, height = 8 ,  units = "in",res = 300)
  print(p)
  dev.off()
  # length(tridat01$group)
  #write.csv(as.data.frame(table(tridat01$group)),"cr.cs.sanyuan.abd.csv")
  
  #as.data.frame(table(tridat01$group)/length(tridat01$group))
  #write.csv(as.data.frame(table(tridat01$group)/length(tridat01$group)),"cr.cs.sanyuan.abd.bili.csv")
}
...
for (ii in unique(cs.samyuan$cs) ) {
  ...
  pdf(paste0("dif_out/ELtoIM.",ii,".to.sanyuan.pdf"),width = 10, height = 10)
  # pdf("A.do.to.sanyuan.pdf",width = 10, height = 10)
  print(p)
  dev.off()
  png(paste0("dif_out/ELtoIM.",ii,".to.sanyuan.png"),width =8, height = 8 ,  units = "in",res = 300)
  print(p)
  dev.off()
  # length(tridat01$group)
  #write.csv(as.data.frame(table(tridat01$group)),"cr.cs.sanyuan.abd.csv")
...
for (ii in unique(cs.samyuan$cs) ) {
  ...
  pdf(paste0("dif_out/IMtoDR.",ii,".to.sanyuan.pdf"),width = 10, height = 10)
  # pdf("A.do.to.sanyuan.pdf",width = 10, height = 10)
  print(p)
  dev.off()
  png(paste0("dif_out/IMtoDR.",ii,".to.sanyuan.png"),width =8, height = 8 ,  units = "in",res = 300)
  print(p)
  dev.off()
  # length(tridat01$group)
  #write.csv(as.data.frame(table(tridat01$group)),"cr.cs.sanyuan.abd.csv")
...
for (ii in unique(cs.samyuan$cs) ) {
  ...
  pdf(paste0("dif_out/DRtoGP.",ii,".to.sanyuan.pdf"),width = 10, height = 10)
  # pdf("A.do.to.sanyuan.pdf",width = 10, height = 10)
  print(p)
  dev.off()
  png(paste0("dif_out/DRtoGP.",ii,".to.sanyuan.png"),width =8, height = 8 ,  units = "in",res = 300)
  print(p)
  dev.off()
  # length(tridat01$group)
  #write.csv(as.data.frame(table(tridat01$group)),"cr.cs.sanyuan.abd.csv")
...
for (ii in unique(cs.samyuan$cs) ) {
  ...
  pdf(paste0("dif_out/GPtoFM.",ii,".to.sanyuan.pdf"),width = 10, height = 10)
  # pdf("A.do.to.sanyuan.pdf",width = 10, height = 10)
  print(p)
  dev.off()
  png(paste0("dif_out/GPtoFM.",ii,".to.sanyuan.png"),width =8, height = 8 ,  units = "in",res = 300)
  print(p)
  dev.off()
  # length(tridat01$group)
  #write.csv(as.data.frame(table(tridat01$group)),"cr.cs.sanyuan.abd.csv")
...
for (ii in unique(cs.samyuan$cs) ) {
  ...
  pdf(paste0("dif_out/FMtoPP.",ii,".to.sanyuan.pdf"),width = 10, height = 10)
  # pdf("A.do.to.sanyuan.pdf",width = 10, height = 10)
  print(p)
  dev.off()
  png(paste0("dif_out/FMtoPP.",ii,".to.sanyuan.png"),width =8, height = 8 ,  units = "in",res = 300)
  print(p)
  dev.off()
  # length(tridat01$group)
  #write.csv(as.data.frame(table(tridat01$group)),"cr.cs.sanyuan.abd.csv")
...
for (ii in unique(cs.samyuan$cs) ) {
  ...
  pdf(paste0("dif_out/PPtoAM.",ii,".to.sanyuan.pdf"),width = 10, height = 10)
  # pdf("A.do.to.sanyuan.pdf",width = 10, height = 10)
  print(p)
  dev.off()
  png(paste0("dif_out/PPtoAM.",ii,".to.sanyuan.png"),width =8, height = 8 ,  units = "in",res = 300)
  print(p)
  dev.off()
  # length(tridat01$group)
  #write.csv(as.data.frame(table(tridat01$group)),"cr.cs.sanyuan.abd.csv")
...
for (ii in unique(cs.samyuan$cs) ) {
  ...
  pdf(paste0("dif_scRNA_ABD/Promeristem_to_Protoxylem.",ii,".to.sanyuan.pdf"),width = 10, height = 10)
  # pdf("A.do.to.sanyuan.pdf",width = 10, height = 10)
  print(p)
  dev.off()
  png(paste0("dif_scRNA_ABD/Promeristem_to_Protoxylem.",ii,".to.sanyuan.png"),width =8, height = 8 ,  units = "in",res = 300)
  print(p)
  dev.off()
  # length(tridat01$group)
  #write.csv(as.data.frame(table(tridat01$group)),"cr.cs.sanyuan.abd.csv")
...
for (ii in unique(cs.samyuan$cs) ) {
  ...
  pdf(paste0("dif_scRNA_ABD/Promeristem_to_Protophloem.",ii,".to.sanyuan.pdf"),width = 10, height = 10)
  # pdf("A.do.to.sanyuan.pdf",width = 10, height = 10)
  print(p)
  dev.off()
  png(paste0("dif_scRNA_ABD/Promeristem_to_Protophloem.",ii,".to.sanyuan.png"),width =8, height = 8 ,  units = "in",res = 300)
  print(p)
  dev.off()
  # length(tridat01$group)
  #write.csv(as.data.frame(table(tridat01$group)),"cr.cs.sanyuan.abd.csv")
